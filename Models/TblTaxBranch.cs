...
{
    public partial class TblTaxBranch
    {
        public TblTaxBranch()
        {
            TblEmployments = new HashSet<TblEmployment>();
            TblTaxBranchSummaries = new HashSet<TblTaxBranchSummary>();
        }
        ...
        public virtual ICollection<TblTaxBranchSummary> TblTaxBranchSummaries { get; set; }
    }
}
